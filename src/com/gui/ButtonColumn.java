...
public class ButtonColumn extends AbstractCellEditor
    ...
    public ButtonColumn(JTable table, Action action, int column) {
        ...
        //renderButton.setBackground(Color.darkGray);
...
//        renderButton.setBorderPainted(true);
//        editButton.setBorderPainted(false);
        UIDefaults def = new UIDefaults();
        
        //def.put("Button[Enabled].contentMargins", new Insets(10, 10, 20, 10));
        //def.put("Button.border", BorderFactory.createEmptyBorder());
        //def.put("Button.borderPainted", false);
        //def.put("Button[MouseOver].background", Color.WHITE);
        //def.put("Button[Enabled].opaque",false);
        //def.put("Button[Enabled].borderPainted",false);
        renderButton.putClientProperty("Nimbus.Overrides", def);
        renderButton.putClientProperty("Nimbus.Overrides.InheritDefaults", false );
        //editButton.putClientProperty("Nimbus.Overrides", def);
        //editButton.putClientProperty("Nimbus.Overrides.InheritDefaults", true);
        //SwingUtilities.updateComponentTreeUI(renderButton);
        //SwingUtilities.updateComponentTreeUI(editButton);
